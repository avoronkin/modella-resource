...
module.exports = function (settings) {
    ...
    return function (Model) {
        Model.middleware = {};
        Model.middleware.id = id = settings.id ? settings.id : 'id'; 
        primaryKey = settings.primaryKey ? settings.primaryKey : '_id';
...
exports.show = function (req, res, next) {
    var query = {};
    query[primaryKey] = req.params[id];
...
exports.update = function (req, res, next) {
    this.get(req.params[id], function (err, model) {
        if (err) return next(err);
        model.set(req.body);
        model.save(function (err) {
            if (err) {
